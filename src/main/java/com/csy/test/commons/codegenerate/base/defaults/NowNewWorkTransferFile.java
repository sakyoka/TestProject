...
public class NowNewWorkTransferFile implements TranferFileBase{
	...
	private static final String PREFIXX_MAPPER_PATH = "src" + File.separator + "main" + File.separator + "resources" + File.separator + "mapper";
		...
		try {
			Files.walkFileTree(inputPath, new SimpleFileVisitor<Path> (){
				...
				public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
		            ...
		            System.out.println();
		            System.out.println("file:" + file + " ===>>> " + targetFile);
